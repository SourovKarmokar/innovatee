      ...
      <Container>
        ...
        <div className='px-[50px]'>
          <div className='flex justify-between'>
            <h2 className='w-[504px] font-primary font-bold text-[46px] leading-[58px] text-title'>How simple is it to use our platform?</h2>
            <p className='w-[530px] font-secondary text-lg leading-[32px] text-discription'>This Innovate Con guide explores the most popular platforms and walks you through how to use them to grow your business.</p>
          </div>
        </div>
        ...
        {/* <div className='w-[300px]  flex  flex-col items-center' >
            ...
            <div className='flex justify-around items-center text-center mt-[116px]'>
                 {
           item.map((item, index) => (
